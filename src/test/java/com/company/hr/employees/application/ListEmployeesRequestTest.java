...
class ListEmployeesRequestTest {
    ...
    void testDefaults() {
        ...
        assertEquals(com.company.hr.employees.domain.EmployeeSortField.NAME, query.getSortBy());
        assertEquals(com.company.hr.shared.domain.SortDirection.ASC, query.getDirection());
    }
